...
class ChordEngineUltimate {
  ...
  buildChordsStableBass(features, key, startFrame, bpm) {
    ...
    console.log(`🎵 v16.26: ${changeFrames.length} chord change candidates`);
  ...
  calcEmitScore(frame, bassNote, energy, energyP70, candidate) {
    ...
    // v16.26: CRITICAL - Hard threshold like v14.36 (reject weak matches)
    if (matchScore < 0.30) return -Infinity;
    ...
    // v16.26: Stronger low energy penalty (like v14.36)
    if (energy < energyP70 * 0.4) score -= 4;
