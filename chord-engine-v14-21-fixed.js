...
class ChordEngineEnhanced {
  constructor() {
    console.log('🎸 ChordEngine v14.21 - FINAL KEY FIX!');
  ...
  async detect(audioBuffer, options = {}) {
    ...
    // This prevents detectTonicMusically from undoing the harmonic validation
    const wasKeyCorrected = (validatedKey.root !== key.root || validatedKey.minor !== key.minor);
