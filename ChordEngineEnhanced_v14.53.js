...
class ChordEngineEnhanced {
  ...
  chordTrackingHMMHybrid(feats, key, bassMultiplier, useFullMode = true) {
    ...
    const emitScore = (i, cand) => {
      ...
      // ✅ FIX 1: Increased diatonic bonus from 0.08 to 0.20 (major improvement!)
      // Give strong preference to in-key chords
      if (cand.diatonic) score += 0.20;
