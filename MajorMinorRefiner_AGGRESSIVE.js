...
class MajorMinorRefiner {
  ...
  _makeDecision(thirdInfo, originalType, originalLabel, opts) {
    ...
    return {
      ...
      // 🔬 DEBUG INFO for CSV export
      debugInfo: {
        majorThirdEnergy: harmonicWeightedMajor.toFixed(4),
        minorThirdEnergy: harmonicWeightedMinor.toFixed(4),
        totalThirdEnergy: totalThirdEnergy.toFixed(4),
        weightedRatioMajor: weightedRatioMajor.toFixed(3),
        weightedRatioMinor: weightedRatioMinor.toFixed(3),
        decisionDiff: diff.toFixed(3),
        originalType,
        qualityRefined
      }
    };
