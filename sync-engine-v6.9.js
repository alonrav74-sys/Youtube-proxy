// =====================================================
// 🎵 SyncEngine v6.9 - Flexible Table (Negina-style)
// =====================================================
// 
...
const SyncEngine = {
  ...
  buildHebrewTableSheet: function(state, whisperWords, whisperText, capo, sanitizeLabel, applyCapoToLabel, fullSheetEl) {
    ...
    // 🎹 בית (Main section)
    html += '<div style="font-size:13px;color:#64748b;margin-bottom:8px;font-weight:700">בית</div>';
    
    // 🔧 KEY: Flexible table - as many cells as needed per line!
        ...
        if (currentLine.length > 0) {
          ...
          for (const cell of currentLine) {
            if (cell.chord) {
              ...
              html += `<td style="padding:4px 12px;vertical-align:bottom;white-space:nowrap"></td>`;
            }
          }
          html += '</tr>';
          ...
          for (const cell of currentLine) {
            if (cell.lyric) {
              ...
              html += `<td style="padding:4px 12px;vertical-align:top;white-space:nowrap"></td>`;
            }
          }
          html += '</tr>';
