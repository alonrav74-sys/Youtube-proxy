// =====================================================
// 🎵 SyncEngine v6.13 - Auto-merge Hebrew (Timeline)
// =====================================================
// 
// Hebrew: Auto-merge chord+lyric if close (<300ms)
// Timeline-based rendering (RTL table)
...
const SyncEngine = {
  ...
  buildHebrewTableSheet: function(state, whisperWords, whisperText, capo, sanitizeLabel, applyCapoToLabel, fullSheetEl) {
    ...
    const MERGE_THRESHOLD = 0.3; // 300ms
    
    // First pass: process chords, merge nearby lyrics
    ...
    // Second pass: add remaining lyrics
    lyrics.forEach((lyric, idx) => {
