  ...
  analyzeHarmonicProgressions(feats, candidateRoot, candidateMinor) {
    ...
    for (let i = 0; i < bassTimeline.length - 1; i++) {
      ...
      if (curr === V && next === I) {
        ...
        console.log(`   ✨ V→I cadence at position ${i} (${this.NOTES_SHARP[V]}→${this.NOTES_SHARP[I]})`);
      }
      ...
      // VII→I (leading tone)
        ...
        console.log(`   ✨ VII→I at position ${i} (${this.NOTES_SHARP[VII]}→${this.NOTES_SHARP[I]})`);
      }
      ...
      // IV→I (plagal)
        ...
        console.log(`   ✨ IV→I at position ${i} (${this.NOTES_SHARP[IV]}→${this.NOTES_SHARP[I]})`);
      }
      ...
      // III→I
        ...
        console.log(`   ✨ III→I at position ${i} (${this.NOTES_SHARP[III]}→${this.NOTES_SHARP[I]})`);
      }
      ...
      if (i < bassTimeline.length - 2) {
        ...
        if (curr === II && next === V && next2 === I) {
          ...
          console.log(`   🔥 II→V→I at position ${i} (${this.NOTES_SHARP[II]}→${this.NOTES_SHARP[V]}→${this.NOTES_SHARP[I]})`);
        }
        ...
        // IV→V→I
          ...
          console.log(`   🔥 IV→V→I at position ${i} (${this.NOTES_SHARP[IV]}→${this.NOTES_SHARP[V]}→${this.NOTES_SHARP[I]})`);
        }
        ...
        // VI→V→I
          ...
          console.log(`   🔥 VI→V→I at position ${i} (${this.NOTES_SHARP[VI]}→${this.NOTES_SHARP[V]}→${this.NOTES_SHARP[I]})`);
        }
      }
    }
