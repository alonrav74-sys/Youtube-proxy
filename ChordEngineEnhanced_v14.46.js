...
class ChordEngineEnhanced {
  ...
  async detect(audioBuffer, options = {}) {
    ...
    if (enginesAgree) {
      ...
      console.log(`   ✅ Engines agree on ${this.NOTES_SHARP[tonic.root]}${tonic.minor ? 'm' : ''}`);
    } else if (humanEarResult && oldTonicResult) {
      // Engines disagree - use simple fallback
      console.log(`   ⚠️ Engines disagree: HumanEar=${this.NOTES_SHARP[humanEarResult.root]}, OldTonic=${this.NOTES_SHARP[oldTonicResult.root]}`);
